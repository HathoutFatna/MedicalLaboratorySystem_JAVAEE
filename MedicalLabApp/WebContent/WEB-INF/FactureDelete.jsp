...
<div class="page-content p-5" id="content">
  <!-- Demo content -->
  <h5 class="display-4 text-white">Supprimer la facture ${ facture.idFacture }</h5><br/>
  <form method="post" >
 <div >
	<div >
		<div >
			...
			<div>
				...
				<a href="/MedicalLaboratoryApp/factures"><button type="button" class="btn btn-info" >Cancel</button></a>
			</div>
		</div>
	</div>
</div> 

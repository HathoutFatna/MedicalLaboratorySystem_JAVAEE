...
<div class="page-content p-5" id="content">
  <!-- Demo content -->
  <h3 class="display-4 text-white">Nouvelle Facture</h3><br/>
  <form method="post" action="/MedicalLaboratoryApp/factures/add">
   <div class="form-group row">
    <label for="id" class="col-sm-2 col-form-label">Id Facture</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control"  name="idFacture" placeholder="Id Facture">
    </div>
  </div>
 <div class="form-group row">
  <label for="example-date-input" class="col-2 col-form-label">Date</label>
  <div class="col-10">
    <input class="form-control" type="date" id="example-date-input" name="DateF" placeholder="Date">
  </div>
</div>
  <div class="form-group row">
    <label for="surname" class="col-sm-2 col-form-label">Prix Total</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="Total" placeholder="Prix DA">
    </div>
  </div>
  <div class="form-group row">
    <label for="age" class="col-sm-2 col-form-label">Id Patient</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="Patient_idPatient" placeholder="Id Patient">
    </div>
  </div>
